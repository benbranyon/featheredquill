...
final class Bundled_Plugins {
	...
	public function __construct() {
		...
		$bundled_plugins = [
			'mwc-core/mwc-core.php'             => version_compare( PHP_VERSION, '7.0', '>=' ) && Plugin::is_plugin_active( 'woocommerce/woocommerce.php' ),
			...
			'godaddy-launch/godaddy-launch.php' => version_compare( PHP_VERSION, '7.4', '>=' ) && Plugin::is_option_autoloaded( 'gdl_enabled', true ),
