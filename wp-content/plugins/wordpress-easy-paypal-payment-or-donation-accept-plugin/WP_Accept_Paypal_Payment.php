...
function wpapp_add_settings_link( $links, $file ) {
	...
	$settings_link = '<a href="options-general.php?page=wordpress-easy-paypal-payment-or-donation-accept-plugin/admin/wpapp_admin_menu.php">' . (__( "Settings", "wp-accept-payments-for-paypal" )) . '</a>';
