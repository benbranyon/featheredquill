    ...
    $.widget("thomaskahn.smoothDivScroll", {
        ...
        _create: function () {
            ...
            $(window).load(function () {
			  ...
			  //console.log("itt "+o.autoScrollingMode+" | "+o.hiddenOnStart+" | "+o.autoScrollingMode);
        ...
        recalculateScrollableArea: function () {
            ...
            el.data("scrollableAreaWidth", tempScrollableAreaWidth+2);
        ...
        startAutoScrolling: function () {
            ...
            if (el.data("enabled")) {
                ...
                el.data("autoScrollingInterval", setInterval(function () {
				  ...
				  //console.log("haho "+el.data("scrollableAreaWidth")+" | "+el.data("scrollWrapper").innerWidth()); 
                    if (!(el.data("visible")) || (el.data("scrollableAreaWidth") <= (el.data("scrollWrapper").innerWidth()))) {
					  ...
					  //console.log("store: "+el.data("scrollWrapper").scrollLeft()+" | "+o.autoScrollingDirection);
                        switch (o.autoScrollingDirection) {
                            ...
                            case "endlessloopright":
                                ...
                                el.data("scrollWrapper").scrollLeft(el.data("scrollWrapper").scrollLeft() + o.autoScrollingStep);
							//console.log("here "+el.data("scrollWrapper").scrollLeft() +"|"+ o.autoScrollingStep);
